            ...
            @foreach ($form->form_data as $formData)
                <div class="form-field-wrapper" id="{{ $loop->index }}">
                    ...
                    <div class="form-field">
                        ...
                        <!-- Check if the field name is "religion" to hide the edit and remove buttons -->
                        @if ($formData->name !== 'religion')
                            <div class="form-field__item">
                                <button type="button" class="btn btn--primary btn-sm editFormData"
                                    data-form_item="{{ $jsonData }}" data-update_id="{{ $loop->index }}">
                                    <i class="las la-pen me-0"></i>
                                </button>
                                <button type="button" class="btn btn--danger btn-sm removeFormData">
                        ...
                        @else
                            <div class="form-field__item">
                                <div class="form-field__item">
                                    <button type="button" class="btn btn--primary btn-sm editFormData" disabled>
                                        <i class="las la-pen me-0"></i>
                                    </button>
                                    <button type="button" class="btn btn--danger btn-sm removeFormData" disabled>
                                        <i class="las la-times me-0"></i>
                                    </button>
                                </div>
                            </div>
