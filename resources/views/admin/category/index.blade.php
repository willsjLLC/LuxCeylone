                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if (strlen($category->description) > 30)
                                                ...
                                                <small class="text--primary catDescription" role="button"
                                                    data-cat_details="{{ __($category->description) }}">@lang('Read More')</small>
                                            @endif
                                        </td>
                                        <td>
                                            @if ($category->status == Status::CATEGORIES_ENABLE)
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu p-0">
                                                ...
                                                @if (!$category->featured)
                                                    <a href="javascript:void(0)" class=" dropdown-item confirmationBtn"
                                                        data-action="{{ route('admin.category.featured', $category->id) }}"
                                                        data-question="@lang('Are you sure to featured this category?')">
                                                        <i class="las la-check-circle"></i> @lang('Featured')
                                                    </a>
                                                @else
                                                    <a href="javascript:void(0)" class=" dropdown-item  confirmationBtn"
                                                        data-action="{{ route('admin.category.featured', $category->id) }}"
                                                        data-question="@lang('Are you sure to not featured this category?')">
