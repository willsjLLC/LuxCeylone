...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <form action="{{ route('admin.report.top-leader-bonus-history') }}" method="GET">
                    ...
                    <table class="table table--light style--two">
                        <thead>
                            <tr>
                                <th>@lang('User')</th>
                                <th>@lang('For Car')</th>
                                <th>@lang('For House')</th>
                                <th>@lang('For Expenses')</th>
                        ...
                        <tbody>
                            @forelse($topLeaders as $history)
                                <tr>
                                    ...
                                    <td class="fw-bold">{{ showAmount($history->for_car) }}</td>

                                    <td class="fw-bold">{{ showAmount($history->for_house) }}</td>

                                    <td class="fw-bold">{{ showAmount($history->for_expenses) }}</td>
