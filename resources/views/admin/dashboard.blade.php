...
@section('panel')
    <div class="row gy-4">
        ...
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.users.banned') }}" icon="fas fa-ban" title="Banned Users"
                value="{{ $widget['ban_users'] }}" bg="danger" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
    ...
    <div class="row mt-2 gy-4">
        ...
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="#" icon="fas fa-box" title="Total Package Activations"
                value="{{ $widget['total_package_activations'] }}" bg="info" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="#" icon="fas fa-check-circle" title="Current Active Packages"
                value="{{ $widget['current_active_packages'] }}" bg="success" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.users.kyc.pending') }}" icon="fas fa-clock" title="KYC Pending Users"
                value="{{ $widget['kyc_pending'] }}" bg="warning" />
        </div><!-- dashboard-w1 end -->
    ...
    <div class="row mt-2 gy-4">
       <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.users.kyc.approved') }}" icon="fas fa-shield-alt" title="KYC Verified Users"
                value="{{ $widget['kyc_verified'] }}" bg="success" />
       </div><!-- dashboard-w1 end -->

       <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.ticket.pending') }}" icon="fas fa-spinner" title="Pending Tickets"
                value="{{ $widget['pending_support_tickets'] }}" bg="warning" />
       </div><!-- dashboard-w1 end -->
       <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.users.leaders.active') }}" icon="fas fa-crown" title="Leaders"
                value="{{ $widget['leaders'] }}" bg="purple" />
       </div><!-- dashboard-w1 end -->
       <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.users.top.leaders') }}" icon="fas fa-crown" title="Top Leaders"
                value="{{ $widget['top_leaders'] }}" bg="success" />
       </div><!-- dashboard-w1 end -->
    ...
    <div class="row mt-2 gy-4">
        ...
        <div class="col-xxl-12">
            <div class="card box-shadow3 h-100">
                <div class="card-body">
                    <h5 class="card-title">@lang('Expenses')</h5>
                    <div class="widget-card-wrapper">
                        <div class="widget-card bg--danger">
                            <a href="{{ route('admin.expenses.index') }}" class="widget-card-link"></a>
                            <div class="widget-card-left">
                                <div class="widget-card-icon">
                                    <i class="las la-money-bill"></i>
                                </div>
                                <div class="widget-card-content">
                                    <h6 class="widget-card-amount">{{ showAmount($expense['total_expense']) }}
                                    </h6>
                                    <p class="widget-card-title">@lang('Total Expenses')</p>
                                </div>
                            </div>
                            <span class="widget-card-arrow">
                                <i class="las la-angle-right"></i>
                        ...
                        <div class="widget-card bg--success">
                            <a href="{{ route('admin.report.company.expenses-saving-history') }}" class="widget-card-link"></a>
                            <div class="widget-card-left">
                                <div class="widget-card-icon">
                                    <i class="las la-piggy-bank"></i>
                                </div>
                                <div class="widget-card-content">
                                    <h6 class="widget-card-amount">{{ showAmount($expense['company_savings']) }}</h6>
                                    <p class="widget-card-title">@lang('Total Company Savings')</p>
                                </div>
                            </div>
                            <span class="widget-card-arrow">
                                <i class="las la-angle-right"></i>
                         ...
                         <div class="widget-card bg--success">
                            ...
                            <div class="widget-card-left">
                                ...
                                <div class="widget-card-content">
                                    <h6 class="widget-card-amount">{{ showAmount($total_company_profit) }}</h6>
                                    <p class="widget-card-title">@lang('Total Company Profit')</p>
                                </div>
                            </div>
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.ads.index') }}" title="Total Ads" icon="lar la-flag"
                value="{{ $ads['total_ads'] }}" bg="primary" outline="true" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.ads.pending') }}" title="Pending Ads"
                icon="fas fa-spinner" value="{{ $ads['pending_ads'] }}" bg="warning" outline="true" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.ads.complete') }}" title="Complete Ads"
                icon="las la-check-circle" value="{{ $ads['complete_ads'] }}" bg="green" outline="true" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.ads.rejected') }}" title="Rejected Ads"
                icon="las la-times-circle" value="{{ $ads['rejected_ads'] }}" bg="16" outline="true" />
        </div><!-- dashboard-w1 end -->
    </div><!-- row end-->
