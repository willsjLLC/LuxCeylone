                ...
                <div class="card-body">
                    ...
                    <div class="p-3 bg--white">
                        <div class="side_Image text-center">
                            <img src="{{ getImage(getFilePath('userProfile') . '/' . $job->user->image, getFileSize('userProfile'),true) }}" alt="@lang('Image')" class="b-radius--10 withdraw-detailImage">
                        </div>
                    </div>
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex justify-content-between pt-2 pb-2 ">
                            @lang('Amount')
                            <span class="fw-bold">{{ showAmount($job->rate) }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between pt-2 pb-2 ">
                            @lang('Total Amount')
                            <span class="fw-bold">{{ showAmount($job->total) }} </span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between pt-2 pb-2 ">
                            @lang('Status')
