...
<head>
    ...
    <title>{{ gs()->siteName($pageTitle ?? '403 | Permission Denied') }}</title>
...
<body>
    <!-- error-403 start -->
    <div class="error" style="background-image: url({{ asset('assets/admin/errors/bg-404.png') }})">
        <div class="container">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-7 text-center">

                    <img src="{{ asset('assets/admin/errors/error-403.png') }}" alt="403 error image">
                    ...
                    <span class="star-glow glow-4"
                        style="background: url({{ asset('assets/errors/images/star-glow.png') }}) no-repeat center"></span>
                    <h2 class="title">@lang('Permission Denied')</h2>
                    <p class="description">@lang('You don\'t have permission to access this page.') <br> @lang('Please contact the administrator if you believe this is a mistake.')</p>
                    <a href="{{ route('admin.dashboard') }}" class="cmn-btn mt-4"><span class="icon">
                        ...
                        </span><span class="text">@lang('Go to Dashboard')</span></a>
                </div>
            </div>
        </div>
    </div>
