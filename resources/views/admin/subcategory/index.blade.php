                        ...
                        <table class="table table--light style--two">
                            <thead>
                                <tr>
                                    ...
                                    <th>@lang('Category')</th>
                                    <th>@lang('Support Conditions (used / new)')</th>
                                    <th>@lang('Status')</th>
                                    <th>@lang('Action')</th>
                                </tr>
                            </thead>
                            <tbody>
                                @forelse ($subCategories as $subCategory)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if (strlen($subCategory->description) > 30)
                                                ...
                                                <small class="text--primary catDescription" role="button"
                                                    data-cat_details="{{ __($subCategory->description) }}">
                                                    @lang('Read More')
                                                </small>
                                            @endif
                                        </td>
                                        ...
                                        <td>
                                            @if ($subCategory->supports_condition == Status::SUB_CATEGORIES_CONDITION_ENABLE)
                                        ...
                                        <td>
                                            @if ($subCategory->status == Status::SUB_CATEGORIES_ENABLE)
