<div class="row g-3 justify-content-center">
    <div class="col-md-6 col-lg-6 col-xl-4">
        <div class="dashboard__card__item">
            ...
            <h2 class="title">{{ gs("cur_sym") }}<span class="odometer" data-odometer-final="{{ $data['balance'] }}">0</span></h2>
    ...
    <div class="col-md-6 col-lg-6 col-xl-4">
        <div class="dashboard__card__item">
            ...
            <h2 class="title">{{ gs("cur_sym") }}<span class="odometer" data-odometer-final="{{ showAmount($data['deposit_balance'], currencyFormat:false) }}">0</span></h2>
            <div class="dashboard__card__item-footer">
    ...
    <div class="col-md-6 col-lg-6 col-xl-4">
        <div class="dashboard__card__item">
            ...
            <h2 class="title">{{ gs('cur_sym') }}<span class="odometer" data-odometer-final="{{ showAmount($data['withdraw_balance'], currencyFormat:false) }}">0</span></h2>
            <div class="dashboard__card__item-footer">
    ...
    <div class="col-md-6 col-lg-6 col-xl-4">
        <div class="dashboard__card__item">
            ...
            <div class="dashboard__card__item-footer">
                <a href="{{ route('user.job.finished') }}?remark=payment_receive">@lang('View Details')</a>
            </div>
        </div>
    </div>
    <div class="col-md-6 col-lg-6 col-xl-4">
