...
<div class="package-activation-notice">
    <div class="package-message">
        <div class="package-text">
            ...
            <strong>@lang('LUXCEYLONE Membership Package')</strong>
            @lang('to access exclusive features and showcase your luxury collections. For assistance, our support team is always here for you.')
            @endif
        </div>
    </div>
</div>
