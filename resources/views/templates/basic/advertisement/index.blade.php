            ...
            <div class="row">
                ...
                <div class="order-1 col-lg-8 col-md-8 col-12 order-md-2">
                    ...
                    <div class="product align-items-center">
                        <div class="mb-2 advertiesment-header d-flex align-items-center">
                            <a href="{{ route('user.product.index') }}" class="text-dark me-3 d-block d-md-none">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="p-0 mb-3 balance-card d-flex align-items-center">
                                <div class="flex-row balance-content d-flex align-items-center w-100">
                                    <div class="mb-0 balance-image">
                                        <img src="{{ asset('assets/image/man.png') }}" alt="Person with ideas"
                                            class="person-img" />
                                    </div>
                                    <div class="text-start balance-text flex-grow-1">
                                        <h4 class="mt-3 mb-1">Do you have something to sell?</h4>
                                        <p class="mb-3">Let's post your first ad!</p>
                                        <div class="mb-3 d-flex action-buttons justify-content-between">
                                            <p class="mt-2 mb-3 mt-md-0">
                                                <a href="{{ route('user.advertisement.myAds') }}" class="my-ad-btn">My
                                                    Ads</a>
                                            </p>
                                            <p class="mt-2 mb-3 mt-md-0">
                                                {{-- @if($remainingAdCount>=0)
                                                    @if ($remainingAdCount == 0)
                                                    <a href="#" class="post-ad-btn expired disabled">+ Post
                                                        Your Ad</a>
                                                @else
                                                    <a href="{{ route('user.advertisement.selectCategory') }}" class="post-ad-btn">+ Post
                                                        Your Ad</a>
                                                    @endif
                                                @else --}}
                                                <a href="{{ route('user.advertisement.selectCategory') }}" class="post-ad-btn">+ Post
                    ...
                    <div class="mb-4 row d-none d-md-flex">
                        <div class="col-12">
                            <div class="search-category-bar d-flex">
                                <div class="category-selector me-3">
                                    <a href="javascript:void(0)" id="selectCategoryBtn" class="btn">
                                        <i class="fa fa-tag me-2" style="color:#1e3774"></i>Select Category
                                    </a>
                                </div>
                                    ...
                                    <div class="category-scroll-container" id="initialCategories">
                                        ...
                                        @foreach ($visibleCategories as $category)
                                            <div class="category-item visible-category">
                                                <a href="{{ route('user.advertisement.category', $category->name) }}"
                                                ...
                                                <div class="category-parent">
                                                    ...
                                                    @if ($category->subCategories && $category->subCategories->count() > 0)
                                                        <div class="subcategory-container"
                                                            ...
                                                            @foreach ($category->subCategories as $subCategory)
                                                                <a href="{{ route('user.advertisement.subCategory', $subCategory->id) }}"
                                                                    class="text-decoration-none">
                                                                    <div class="subcategory-list-row">
                                                                        <div class="subcategory-list-content">
...
@push('script')
    ...
    <style>
        ...
        .balance-card {
            ...
            background: linear-gradient(to bottom, rgba(6, 113, 113, 1), rgba(92, 233, 210, 1));
            border-radius: 4px;
            padding: 20px;
