    ...
    <div class="col-12">
        <div class="row">
            <div class="d-flex justify-content-between align-items-center mb-4 mt-10">
                            <h3 class="fw-bold text-dark">Job Edit</h3>
                <a href="{{route('user.job.history')}}" class="btn btn--sm btn--base">
                    Go Back
                </a>
            </div>
            ...
            <div class="col-lg-9 col-md-8">
                <div class="row">
                    ...
                    <div class="ashboard__content contact__form__wrapper bg-white">
                        <div class="campaigns__wrapper">
                            <div class="">
                                <form class="create__campaigns__form" action="{{ route('user.job.update', $job->id) }}"
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="thumb">
                                                        <div class="avatar-preview">
                                                            <div class="profilePicPreview w-100" id="previewImg"
                                                                style="background-image: url({{ getImage(getFilePath('jobPoster') . '/' . @$job->attachment, getFileSize('jobPoster')) }})">
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="col-xl-9 col-lg-7 col-md-7">
                                            <div class="form-group ">
                                                ...
                                                <select class="form-control form-select select2 form--control h-50 w-100"
                                                    ...
                                                    @foreach ($categories as $category)
                                                        <option value="{{ $category->id }}" @selected($job->category_id == $category->id)
                                                            ...
                                                            data-subcategory="{{ $job->subcategory_id }}">
                                                            {{ $category->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="row my-3">
                                        ...
                                        <div class="col-xl-12">
                                            <div class="form-group ">
                                                ...
                                                <select class="form-contro form-select form--control h-50 w-100"
                                                    name="job_proof" id="fileOption" required>
                                            ...
                                            @foreach ($files as $file)
                                                <div class="form-group me-2">
                                                    ...
                                                    <label class="form-check-label"
                                                        for="inlineRadio{{ $file->id }}">{{ $file->name }}</label>
                                                </div>
                                            @endforeach
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" step="any" name="rate"
                                                        ...
                                                        value="{{ getAmount($job->rate) }}">
                                                    <div class="input-group-text bg--base text--white">
                                                        {{ gs('cur_text') }}</div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="total_budget"
                                                        ...
                                                        value="{{ getAmount($job->total) }}" readonly>
                                                    <div class="input-group-text bg--base text--white">
                                                        {{ gs('cur_text') }}</div>
                                                </div>
                                            </div>
