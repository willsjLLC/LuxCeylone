...
@section('panel')
    <div class="container">
        <div class="row">
            ...
            <h3 class="fw-bold text-dark mobile-view-margin">Leader Bonus Transactions</h3>
            <!-- Sidebar (Left) -->
                                    ...
                                    <tr>
                                        ...
                                        <td class="budget">
                                            <span class="fw-bold text--success">
                                                {{ showAmount($trx->leader_bonus) }}
                                            </span>
                                        </td>

                                        <td class="budget">
                                            <span class="fw-bold text--success">
                                                {{ showAmount($trx->leader_vehicle_lease) }}
                                            </span>
                                        </td>

                                        <td class="budget">
                                            <span class="fw-bold text--success">
                                                {{ showAmount($trx->leader_petrol) }}
                                            </span>
                                        </td>
