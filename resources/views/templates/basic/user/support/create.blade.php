...
@section('panel')
<h3 class="mb-4 fw-bold text-dark mobile-view-margin mt-3">New Ticket</h3>
    <div class="dashboard__content contact__form__wrapper bg-white">
        <div class="text-end">
            <a href="{{ route('ticket.index') }}" class="btn btn--sm btn--base mb-2">
        ...
        <form action="{{ route('ticket.store') }}" class="disableSubmission" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-xl-9  col-md-8">
                    ...
                    <p class="mb-2 fs-small"><span class="text--black">@lang('Max 5 files can be uploaded | Maximum upload size is ' . convertToReadableSize(ini_get('upload_max_filesize')) . ' | Allowed File Extensions: .jpg, .jpeg, .png, .pdf, .doc, .docx')</span></p>
