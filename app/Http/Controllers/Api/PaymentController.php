...
class PaymentController extends Controller
{
    ...
    //     // Check if transaction ID exists in deposits
    //     $exists = Deposit::whereIn('status', [Status::PAYMENT_SUCCESS, Status::PAYMENT_PENDING])
    //         ->whereNotNull('detail')
    //         ->get()
    //         ->contains(function ($deposit) use ($transactionId) {
    ...
    //             return $existingSlipNumber && $existingSlipNumber == $transactionId;
    //         });
