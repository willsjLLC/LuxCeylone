...
class JobController extends Controller
{
    ...
    public function approve($id)
    {
        ...
        notify($job->user, 'ADMIN_JOB_APPROVE', [
            ...
            'total'     => showAmount($job->total, currencyFormat: false),
        ]);
    ...
    public function reject($id)
    {
        ...
        $transaction->amount       =$jobBalance;
        $transaction->post_balance = $companyAccount->balance -$jobBalance;
        ...
        $companyAccount->balance -= $jobBalance;
        $companyAccount->save();
    ...
    public function details($id)
    {
        ...
        $job       = JobPost::where('id', $id)->with('proves', function ($query) {
