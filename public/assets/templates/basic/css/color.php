...
.price,.job__item-content .title a:hover, .social-links li a,.header__top__wrapper .contacts li a:hover,.text--base,.subtitle,.counter__item-icon,.about__content .about__info li::before,.service__item-icon,.footer__widget .widget-title,.faq__tab__menu .tab__link:hover *, .faq__tab__menu .tab__link.active *,.user__profile-content .designation,.dashboard__sidebar__menu li a:hover, .dashboard__sidebar__menu li a.active,.dashboard__sidebar__menu li a:hover,.overview__content__wrapper .btn,.title a:hover,.read-more:hover,.footer-links li a:hover,.latest-posts .post-info .posts-date i,.announcement__meta li i,.sidebar__widget .info__item .content .title,
...
.scrollToTop,.counter__item::before, .counter__item::after,.overview__content__wrapper.right-bg .btn, .container-fluid, .read-more:hover::before,.bg--base {
background-color: <?php echo $color ?> !important;
}
...
.social-links li a,.form--control:focus,.nice-select:focus, .pagination .page-item span{
